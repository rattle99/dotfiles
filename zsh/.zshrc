...
# Zellij shell integration - enables auto-naming tabs/panes
if [[ -n "$ZELLIJ" ]]; then
...
# Vim XDG config dir
export VIMINIT='if has("nvim") | source $HOME/.config/nvim/init.lua | else | let $MYVIMRC="$HOME/.config/vim/vimrc" | source $MYVIMRC | endif'
